...
# client can be "chrome" or "firefox"
client = "chrome"
language = "pt"
...
answers = r.json()[1]
print(answers)
## the number of results varies a lot. If you want to limit the answers, just uncomment
## the two lines below and adjust the "limit" parameter
#limit = 8
